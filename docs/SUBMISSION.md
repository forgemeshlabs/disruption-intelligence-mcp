...
`io.github.forgemeshlabs/disruption-intelligence-mcp@0.1.5`
...
- "Get the location-only Ripple Index for California and show which signal IDs have high freshness."
